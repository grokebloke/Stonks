...
for date in timelist:
    ...
    for elem in title_list:
        ...
        out1 = valid.split("=")[2][1:-8]
        out2 = valid.split("=")[-7].split("<")[0][23:-4]
        url.append(out1)
        title.append(out2)
        #if it == 1:
            #print(out1)
...
to_merge.to_csv('AMAZON_stock_related.csv')
